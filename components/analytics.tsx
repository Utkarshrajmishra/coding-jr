...
import { IoDocumentText, IoCart, IoPricetagSharp, IoPricetagOutline } from "react-icons/io5";
...
export function Analyatics() {
  return (
    <div className="w-[700px] p-4 bg-white border border-gray-200 rounded-xl h-fit">
